...
export const getAllDeliiveryPartner: any = createAsyncThunk(
    ...
    async (params: any, thunkAPI) => {
        try {
            console.log(params)
            // const response = await apiService.post('search_delivery_partner', params);
...
export const createDeliiveryPartner: any = createAsyncThunk(
    ...
    async (params: any, thunkAPI) => {
        console.log(params)
        try {
            const response = await apiService.post('create_delivery_partner', params, PORT, PRIFIX_URL);
            console.log(response)
        } catch (error: any) {
...
export const updateDeliiveryPartner: any = createAsyncThunk(
    ...
    async (params: DeliveryPartner, thunkAPI) => {
        try {
            const response = await apiService.put('edit_delivery_partner', params, PORT, PRIFIX_URL);
            if (response) {
                return response;
            } else {
...
export const deleteDeliiveryPartner: any = createAsyncThunk(
    ...
    async (params: DeliveryPartner, thunkAPI) => {
        try {
            const response = await apiService.post('delete_delivery_partner', params, PORT, PRIFIX_URL);
            if (response) {
                return response;
            } else {
                const errorMessage = 'Something went wrong';
