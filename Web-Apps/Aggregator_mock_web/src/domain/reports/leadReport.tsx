...
import Reports_modal from "../../tech/core/modals/reports_modal";
import Table from "../../tech/core/common/dataTable/index";
import { DailyReportData } from "../../tech/core/json/dealReportsData";
import { TableData } from "../../tech/core/data/interface";
import ImageWithBasePath from "../../tech/core/common/imageWithBasePath";
import { leadsReportsData } from "../../tech/core/json/leads";
...
const LeadReport = () => {
  ...
  const [chartOptions1] = useState<any>({
    ...
    colors: ["#0092E4", "#4A00E5", "#ff7e00", "#FFA201"],
    dataLabels: {
      enabled: false,
    },
    plotOptions: {
    ...
    },
    {
      ...
      render: (text: any, record: any) => (
        <h2 className="table-avatar d-flex align-items-center">
          <Link to={route.manageUsers} className="company-img">
            <ImageWithBasePath
                ...
                <div className="row align-items-center">
                  <div className="col-sm-8">
                    <h4 className="page-title">
                      Remote Location Report <span className="count-title">123</span>
                    </h4>
                  </div>
                      ...
                      <div className="col-md-5 col-sm-4">
                        <div className="form-wrap icon-form">
                          ...
                          <input
                            ...
                            placeholder="Search Remote Location"
                          />
                        </div>
                      </div>
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-5 d-flex">
                      <div className="card report-card w-100">
                        <div className="card-body">
                          <div className="statistic-header report-header">
                            <h4>Remote Location by Source</h4>
                            <div className="statistic-dropdown">
                              <div className="icon-form">
                                <span className="form-icon">
                                  <i className="ti ti-calendar" />
