...
const PurchaseOrderModal = (modalData: any) => {
    ...
    const columns: TableProps<any>['columns'] = [
        {
            ...
            render: (text: any) => {
                ...
                return (
                    <>
                        {orderItem ? orderItem.description : 'Not Found'}
                    </>
                );
            },
        },
    ...
    return (
        <div className="modal custom-modal fade " id="add_purchaseOrder" role="dialog">
            <div className="modal-dialog modal-dialog-centered modal-lg">
                <div className="modal-content">
                    <div className="modal-header">
                        ...
                        {modalData?.modalData ? (
                            <>
                                <h5 className="modal-title">Edit PurchaseOrder</h5>
                            </>
                        ) : (
                            <>
