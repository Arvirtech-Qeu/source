...
const QboxDashboard = () => {
  ...
  useEffect(() => {
    const isPathWithLoader =
      location.pathname === route.qboxDashboard ||
      location.pathname === route.remoteLocationPerformance ||
      location.pathname === route.skuMovement
              ...
              <div className="page-header">
                <div className="row align-items-center ">
                  <div className="col-md-4">
                    <h3 className="page-title">Q-Box Dashboard</h3>
                  </div>
