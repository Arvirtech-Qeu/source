...
import Loader from "../../../tech/core/common/loader";
import { all_routes } from "../../../tech/router/all_routes";
 
const route = all_routes;
const RemoteLocationPerformance = () => {
              ...
              <div className="page-header">
                <div className="row align-items-center ">
                  <div className="col-md-4">
                    <h3 className="page-title">Remote Location Dashboard</h3>
                  </div>
                    ...
                    <div className="card-body">
                      <div className="statistic-header">
                        <h4>
                          ...
                          Recently Created Remote Location
                        </h4>
                    ...
                    >
                      <div className="content-collapse">
                        <div className="row">
                          ...
                          <div className="col-md-6">
                            <div className="form-wrap">
                              <label className="col-form-label">Q-Box</label>
                              <select className="select2">
                                <option>Choose</option>
            ...
            <div className="modal-body">
              <div className="success-message text-center">
                ...
                <div className="col-lg-12 text-center modal-btn">
                  ...
                  <Link to={route.deliveryPartners} className="btn btn-danger">
                    Yes, Delete it
                  </Link>
                </div>
              </div>
            ...
            <div className="modal-body">
              <div className="success-message text-center">
                ...
                <div className="col-lg-12 text-center modal-btn">
                  ...
                  <Link to={route.deliveryPartners} className="btn btn-primary">
                    View Details
                  </Link>
                </div>
              </div>
...
export default RemoteLocationPerformance;
