...
const getModuleIcon = (moduleName: any) => {
      ...
      >
        <Card
          ...
          className={`
            ...
            ${isActive
              ? 'bg-red-600 text-black shadow-2xl'
        ...
        >
          ...
          <div className="relative p-4 h-full flex flex-col justify-between">
            <div className="flex items-center justify-between">
              <div className={`p-2 rounded-lg ${isActive ? 'text-white' : 'text-red-600'
                }`}>
...
const ModuleSelector = ({ modulesList, activeTab, setActiveTab, handleModuleClick, searchTerm }: any) => {
  ...
  // const selectedModule = modulesList?.find((module: any) => module.moduleId === activeTab);
  const selectedModule = filteredModules?.find((module: any) => module.moduleId === activeTab) || null;
            ...
            >
              {filteredModules.map((module: any) => (
                <RoleCard
                  key={module.moduleId}
                  module={module}
                  isActive={activeTab === module.moduleId}
                  onClick={() => {
                    setActiveTab(module.moduleId);
      ...
      {selectedModule && (
        ...
        >
          <div className='flex  bg-red-600 text-white  py-4 rounded-lg p-5'>
            <h3 className="font-semibold ">Selected Module : {selectedModule.moduleName}</h3>
          </div>
        </motion.div>
      )}
    </div>
